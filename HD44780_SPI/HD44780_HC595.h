#ifndef HD44780_HC595_H_
#define HD44780_HC595_H_
...
#define STCP_HIGH	STCP_PORT|=(1<<STCP_PIN)
#define STCP_LOW	STCP_PORT&=~(1<<STCP_PIN)

#define SHCP_HIGH	SHCP_PORT|=(1<<SHCP_PIN)	
#define SHCP_LOW	SHCP_PORT&=~(1<<SHCP_PIN)
...
/* RS */
#define RS_HIGH		send_to_register( 1<<RS_BIT_POS, HIGH)
#define RS_LOW		send_to_register( 1<<RS_BIT_POS, LOW)


/* RW */  //CONNECT TO GND
//#define RW_HIGH	send_to_register( 1<<RW_BIT_POS, HIGH)
//#define RW_LOW	send_to_register( 1<<RW_BIT_POS, HIGH)


/* E */
#define E_HIGH		send_to_register( 1<<E_BIT_POS, HIGH)
#define E_LOW		send_to_register( 1<<E_BIT_POS, LOW)

/* D4...D7*/
#define D4_HIGH		send_to_register( 1<<D4_BIT_POS, HIGH)
#define D4_LOW		send_to_register( 1<<D4_BIT_POS, LOW)

#define D5_HIGH		send_to_register( 1<<D5_BIT_POS, HIGH)
#define D5_LOW		send_to_register( 1<<D5_BIT_POS, LOW)

#define D6_HIGH		send_to_register( 1<<D6_BIT_POS, HIGH)
#define D6_LOW		send_to_register( 1<<D6_BIT_POS, LOW)

#define D7_HIGH		send_to_register( 1<<D7_BIT_POS, HIGH)
#define D7_LOW		send_to_register( 1<<D7_BIT_POS, LOW)

//#define LED_ENABLE		send_to_register( 1<<LED_BIT_POS, HIGH)
//#define LED_DISABLE		send_to_register( 1<<LED_BIT_POS, LOW)

//#define BUZZER_ENABLE		send_to_register( 1<<BUZZER_BIT_POS, HIGH)
//#define BUZZER_DISABLE	send_to_register( 1<<BUZZER_BIT_POS, LOW)
